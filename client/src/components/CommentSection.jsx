    ...
    <div className="max-w-2xl mx-auto w-full p-3">
      ...
      {currentUser && (
        <form className="border border-teal-500 rounded-md p-3" onSubmit={handleSubmit}>
          <Textarea
            className="pt-2 pl-2 rounded-md"
          ...
          <div className="flex justify-between mt-5">
            ...
            <Button outline gradientDuoTone={'purpleToBlue'} type="submit">Submit</Button></div>
        ...
        <Modal.Body>
          <div className='text-center'>
            ...
            <div className='flex justify-center gap-4'>
              <Button
                color='failure'
                onClick={() => { setShowModal(false);handleDelete(commentToDelete);}}
              >
                Yes, I&apos;m sure
              </Button>
